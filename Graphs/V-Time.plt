...
set ylabel "{/Arial:Roman=20 {/Arial:Italic=20 V} (V)}" offset 1.2 font "Arial,12"
...
set output "V-TimeSim.png"

set datafile separator comma
#set datafile separator ", "

#plot "GTIVTimeSim.dat" using 5:1 with linespoints pt 7 lc "red" ps 0.5 notitle
plot "../Dat/GTIVTimeSim.dat" using 5:($4) with linespoints pt 7 lc "blue" ps 0.5 axes x1y1 title "{/Arial:Italic=20 Vmeas}" at 0.8, 0.9,\
 "../Dat/GTIVTimeSim.dat" using 5:($7) with linespoints pt 7 lc "red" ps 0.5 axes x1y2 title "{/Arial:Italic=20 Vsim}" at 0.8, 0.83
