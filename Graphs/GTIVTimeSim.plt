...
set output "GTIVTimeSim.png"

set datafile separator comma
#set datafile separator ", "

#plot "GTIVTimeSim.dat" using 5:1 with linespoints pt 7 lc "red" ps 0.5 notitle
plot "../Dat/GTIVTimeSim.dat" using 5:($1) with linespoints pt 7 lc "red" ps 0.5 axes x1y1 title "{/Arial:Italic=20 G}" at 0.8, 0.9,\
 "../Dat/GTIVTimeSim.dat" using 5:($2) with linespoints pt 7 lc "blue" ps 0.5 axes x1y2 title "{/Arial:Italic=20 T}" at 0.8, 0.83
