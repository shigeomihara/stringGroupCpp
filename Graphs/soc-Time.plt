...
set ylabel "{/Arial:Roman=20 SOC}" offset 1.2 font "Arial,12"
...
set output "soc-TimeSim.png"

set datafile separator comma
#set datafile separator ", "

#plot "GTIVTimeSim.dat" using 5:1 with linespoints pt 7 lc "red" ps 0.5 notitle
plot "../Dat/socTimeSim.dat" using 1:($2) with linespoints pt 7 lc "red" ps 0.5 axes x1y1 notitle
